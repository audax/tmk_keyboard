...
[_NE] = { /* Neo 2 Soft */
  ...
  {KC_LGUI,      KC_LALT, S(KC_LGUI),       MO(_RS),  KC_LCTL, KC_SPC,     LT(_LW, KC_ENT),KC_LCTL, F(0),    KC_PGUP, KC_PGDN, S(KC_INS)}
},
[_RS] = { /* RAISE */
  {KC_GRV,       KC_1,    KC_2,    KC_3,    KC_4,     KC_5,     KC_6,      KC_7,           KC_8,    KC_9,    KC_0,    KC_TRNS},
  {KC_TRNS,      KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,    KC_F6,     KC_TRNS,        KC_TRNS,  KC_TRNS, KC_TRNS, M(M_AT)},
...
[_LW] = { /* LOWER */
  {KC_TRNS,     KC_PGUP,  KC_BSPC,  KC_UP,  KC_DEL,   KC_PGDN,  KC_0,     KC_1,            KC_2,     KC_3,  NEO_SS,  KC_DEL},
  {KC_TRNS,     KC_HOME,  KC_LEFT,  KC_DOWN,KC_RIGHT, KC_END,   KC_GRV,   KC_4,            KC_5,     KC_6,  LALT(KC_TAB),  M(M_AT)},
